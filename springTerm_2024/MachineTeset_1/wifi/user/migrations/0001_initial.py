    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='admin', max_length=10, verbose_name='姓名')),
                ('phone_number', models.CharField(max_length=11, unique=True, verbose_name='电话号码')),
                ('limit', models.SmallIntegerField(choices=[(0, 'student'), (1, 'teacher'), (2, 'admin')], default=0, verbose_name='权限')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('m', '男'), ('f', '女')], default='m', max_length=1, verbose_name='性别')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '学生信息',
